...
@section('content')
    <div class="container-fluid p-0">
        <h3 class="mb-3"><strong>Pengaturan Profil</strong></h3>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xl-3">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title mb-0 mt-2">{{ $user->name }}</h5>
                        ...
                        <hr class="my-3" />
                        <small class="text-muted d-block mb-2">Klik tombol edit pada foto untuk memilih foto baru.</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8 col-xl-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formProfile" data-parsley-validate>
                            @csrf
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="name">Nama Lengkap</label>
                                    <input type="text" class="form-control" id="name" name="name" 
                                           value="{{ $user->name }}" required data-parsley-maxlength="255">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="email">Alamat Email</label>
                                    <input type="email" class="form-control" id="email" name="email" 
                                           value="{{ $user->email }}" required data-parsley-type="email" data-parsley-maxlength="255">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary">
                                <i class="align-middle me-1" data-feather="save"></i> Simpan Perubahan
                            </button>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Submit Profile Information & Photo via AJAX
                ...
                if ($(this).parsley().isValid()) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            // Create FormData to support both text fields and file upload
                            let formData = new FormData($(this)[0]);
                            
                            // Append file if selected in photo form
