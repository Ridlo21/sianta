                    ...
                    <div class="card-body p-4 p-lg-5">
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-lg-3 text-center text-lg-start">
                                <div class="d-inline-block position-relative">
                                    <img src="{{ $foto }}"
                                        class="rounded-4 shadow-sm border border-light border-4 img-thumbnail"
                                        style="width: 200px; height: 260px; object-fit: cover;">
                                </div>
                                @if ($guru->foto)
                                    <div class="mt-3 px-3">
                                        <a href="{{ route('guru.lengkapi_data.download.berkas', 'foto') }}"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 col-lg-4">
                                        <div class="p-3 bg-light rounded-4 border border-light-subtle h-100">
                                            <small class="text-muted d-block fw-semibold mb-1"><i
                                                    class="fas fa-id-card me-1"></i> NIK</small>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="p-3 bg-light rounded-4 border border-light-subtle h-100">
                                            <small class="text-muted d-block fw-semibold mb-1"><i
                                                    class="fas fa-calendar-alt me-1"></i> TTL</small>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="p-3 bg-light rounded-4 border border-light-subtle h-100">
                                            <small class="text-muted d-block fw-semibold mb-1"><i
                                                    class="fas fa-user-tag me-1"></i> Jenis GTK</small>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="p-3 bg-light rounded-4 border border-light-subtle h-100">
                                            <small class="text-muted d-block fw-semibold mb-1"><i
                                                    class="fas fa-briefcase me-1"></i> Jabatan GTK</small>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="p-3 bg-light rounded-4 border border-light-subtle h-100">
                                            <small class="text-muted d-block fw-semibold mb-1"><i
                                                    class="fas fa-venus-mars me-1"></i> Jenis Kelamin</small>
                                            <span
                                                class="fw-bold text-dark fs-6">{{ $guru->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="p-3 bg-light rounded-4 border border-light-subtle h-100">
                                            <small class="text-muted d-block fw-semibold mb-1"><i
                                                    class="fas fa-pray me-1"></i> Agama</small>
                                            <span
                                                class="fw-bold text-dark fs-6">{{ $guru->agama->nama_agama ?? '-' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="border-top mt-4 pt-4">
                            <div class="row g-4 align-items-center">
                                {{-- ALAMAT --}}
                                <div class="col-lg-8">
                                    <small class="text-muted d-block fw-bold mb-1"><i
                                            class="fas fa-map-marker-alt me-1 text-danger"></i> Alamat Lengkap</small>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div
                                        class="border rounded-4 p-3 bg-light-soft h-100 d-flex justify-content-between align-items-center">
                                        <div>
                                            <small class="text-muted d-block fw-semibold mb-1">Pemberkasan</small>
                                            @if ($berkasLengkap == $totalBerkas)
                                                <div class="fw-extrabold text-success fs-5"><i
                                                        class="fas fa-check-circle me-1"></i> Lengkap</div>
                                            @else
                                                <div class="fw-extrabold text-warning fs-5"><i
                                                        class="fas fa-exclamation-circle me-1"></i> Belum Lengkap</div>
                                            @endif
                                        </div>
                                        <div class="text-end d-flex align-items-center">
                                            <span
                                                class="badge {{ $berkasLengkap == $totalBerkas ? 'bg-success' : 'bg-warning text-dark' }} px-3 py-2 fs-6 rounded-pill">
                                                {{ $berkasLengkap }} / {{ $totalBerkas }} Berkas
                                            </span>
                                            @if ($berkasLengkap < $totalBerkas)
                                                <a href="{{ route('guru.lengkapi_data.upload') }}" class="btn btn-warning btn-sm ms-2 fw-semibold" style="border-radius: 20px;">
                                                    Lengkapi
                                                </a>
                                            @endif
                                        </div>
                    ...
                    <div class="card-body p-4">
                        <ul class="nav nav-pills nav-pills-custom mb-4" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-pendidikan-tab" data-bs-toggle="pill"
                                    data-bs-target="#tab-3" type="button" role="tab"><i
                                        class="fas fa-graduation-cap me-1"></i> Riwayat Pendidikan</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-kepegawaian-tab" data-bs-toggle="pill"
                                    data-bs-target="#tab-1" type="button" role="tab"><i
                                        class="fas fa-user-tie me-1"></i> Kepegawaian & Kontak</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-keluarga-tab" data-bs-toggle="pill"
                                    data-bs-target="#tab-2" type="button" role="tab"><i
                                        class="fas fa-users me-1"></i> Keluarga</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-berkas-tab" data-bs-toggle="pill"
                                    data-bs-target="#tab-4" type="button" role="tab"><i
                                        class="fas fa-folder-open me-1"></i> Data Berkas</button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="tab-1" role="tabpanel">
                                <h4 class="fw-bold mb-3 text-dark"><i class="fas fa-info-circle me-1 text-primary"></i>
                                    Data Kepegawaian & Kontak</h4>
                                <div class="row border rounded-4 bg-white overflow-hidden g-0">
                                    <div class="col-md-6">
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-id-card-alt text-muted"></i> Status
                                                Kepegawaian</div>
                                            <div class="detail-value text-dark">{{ $guru->status_kepegawaian ?? '-' }}
                                            </div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-file-contract text-muted"></i> SK
                                                Pengangkatan</div>
                                            <div class="detail-value text-dark">{{ $guru->sk_pengangkatan ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-calendar-check text-muted"></i> TMT
                                                Pengangkatan</div>
                                        ...
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-landmark text-muted"></i> Lembaga
                                                Pengangkat</div>
                                            <div class="detail-value text-dark text-uppercase">
                                                {{ $guru->lembaga_pengangkat ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-file-signature text-muted"></i> No.
                                                Surat Tugas</div>
                                            <div class="detail-value text-dark">{{ $guru->no_surat_tugas ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-calendar-day text-muted"></i>
                                                Tanggal Surat Tugas</div>
                                            <div class="detail-value text-dark">
                                                {{ $guru->tgl_surat_tugas ? \Carbon\Carbon::parse($guru->tgl_surat_tugas)->locale('id')->translatedFormat('d F Y') : '-' }}
                                            </div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-hourglass-end text-muted"></i>
                                                Tahun Pensiun</div>
                                            <div class="detail-value text-dark">{{ $guru->tahun_pensiun ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-ring text-muted"></i> Status
                                                Perkawinan</div>
                                            <div class="detail-value text-dark">
                                                {{ ucwords($guru->status_perkawinan ?? '-') }}</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 border-start">
                                        ...
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-user-tag text-muted"></i> Nama
                                                Wajib Pajak</div>
                                            <div class="detail-value text-dark text-uppercase">
                                                {{ $guru->nama_wajib_pajak ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-graduation-cap text-muted"></i>
                                                Status Kuliah</div>
                                            <div class="detail-value text-dark">
                                        ...
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-users-cog text-muted"></i> Jenis
                                                GTK</div>
                                            <div class="detail-value text-dark">{{ $guru->jenis_gtk ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-user-shield text-muted"></i>
                                                Jabatan GTK</div>
                                            <div class="detail-value text-dark">{{ $guru->jabatan_gtk ?? '-' }}</div>
                                        </div>
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-envelope text-muted"></i> Email
                                            </div>
                                        ...
                                        <div class="detail-row">
                                            <div class="detail-label"><i class="fas fa-mail-bulk text-muted"></i> Kode Pos
                                            </div>
                            ...
                            <div class="tab-pane fade" id="tab-2" role="tabpanel">
                                <h4 class="fw-bold mb-3 text-dark"><i class="fas fa-users text-primary mb-0"></i>
                                    Informasi Keluarga</h4>
                                <div class="row g-4">
                                    {{-- IBU KANDUNG --}}
                                    <div class="col-md-6">
                                        <div class="parent-card">
                                            <div class="parent-header d-flex justify-content-between align-items-center">
                                                <h5 class="fw-bold text-danger mb-0"><i
                                                        class="fas fa-female me-1 fs-5"></i> IBU KANDUNG</h5>
                                                <span
                                                    class="info-pill bg-danger-subtle text-danger border-danger-subtle">IBU</span>
                                            </div>
                                            <div class="p-3">
                                                <div class="detail-row">
                                                    <div class="detail-label">Nama Ibu</div>
                                                    <div class="detail-value text-uppercase text-dark">
                                                        {{ $guru->keluarga->nama_ibu ?? '-' }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @if ($guru->status_perkawinan == 'kawin')
                                        <div class="col-md-6">
                                            <div class="parent-card">
                                                <div
                                                    class="parent-header d-flex justify-content-between align-items-center">
                                                    <h5 class="fw-bold text-primary mb-0"><i
                                                            class="fas fa-ring me-1 fs-5"></i> PASANGAN (SUAMI / ISTRI)
                                                    </h5>
                                                ...
                                                <div class="p-3">
                                                    <div class="detail-row">
                                                        ...
                                                        <div class="detail-value text-uppercase text-dark">
                                                            {{ $guru->keluarga->nama_pasangan ?? '-' }}</div>
                                                    </div>
                                                    <div class="detail-row">
                                                        <div class="detail-label">Pekerjaan Pasangan</div>
                                                        <div class="detail-value">
                                                            {{ $guru->keluarga->pekerjaanPasangan->nama_pekerjaan ?? '-' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade show active" id="tab-3" role="tabpanel">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h4 class="fw-bold text-dark mb-0"><i
                                            class="fas fa-graduation-cap text-primary me-1"></i> Riwayat Pendidikan</h4>
                                        ...
                                        <tbody>
                                            @forelse ($guru->pendidikan as $index => $edu)
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td><span
                                                            class="badge bg-secondary-subtle text-secondary px-3 py-1.5 rounded-pill fw-bold">{{ $edu->jenjang }}</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($edu->scan_file_ijazah)
                                                            @php
                                                                $edu_path =
                                                                    'gambar_berkas/berkas_guru/' .
                                                                    $edu->scan_file_ijazah;
                                                            @endphp
                                                            <div class="d-flex gap-1">
                                                                ...
                                                                <a href="{{ route('guru.lengkapi_data.pendidikan.download', $edu->id) }}"
                            ...
                            <div class="tab-pane fade" id="tab-4" role="tabpanel">
                                <div
                                    ...
                                    <h4 class="fw-bold mb-0 text-dark"><i
                                            class="fas fa-folder-open text-primary me-1"></i> Dokumen Pendukung & Berkas
                                    </h4>
                                    @if (
                                        $guru->foto ||
                                            $guru->scan_kk ||
                                            ...
                                            $guru->scan_sk ||
                                            $guru->scan_transkrip_nilai)
                                        <a href="{{ route('guru.download.zip', $guru) }}"
                                            class="btn btn-success fw-bold shadow-xs">
                                ...
                                <div class="row g-4 justify-content-center">
                                    @php
                                        ...
                                        $transkrip_file = $guru->scan_transkrip_nilai
                                            ...
                                            : 'asset_admin/img/notfound.png';
                                        $isTranskripPdf =
                                            strtolower(pathinfo($transkrip_file, PATHINFO_EXTENSION)) === 'pdf';
                                    @endphp

                                    {{-- FOTO GURU --}}
                                    <div class="col-md-6 col-lg-4">
                                        <div
                                            class="doc-card p-3 shadow-xs text-center h-100 d-flex flex-column justify-content-between">
                                            <div>
                                                <h6 class="fw-extrabold text-dark mb-2"><i
                                                        class="far fa-image text-primary me-1"></i> Foto Guru</h6>
                                                <div class="doc-img-container shadow-xs mb-3 border">
                                                    @if ($isFotoPdf)
                                                        <i class="far fa-file-pdf text-danger fs-1"
                                                            style="cursor: pointer;"
                                                            onclick="openPreview('{{ asset($foto_file) }}', 'Foto Guru')"></i>
                                                    @else
                                                        <img src="{{ asset($foto_file) }}" alt="Foto Guru"
                                                            style="cursor:pointer;"
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div
                                            ...
                                            <div>
                                                <h6 class="fw-extrabold text-dark mb-2"><i
                                                        class="far fa-file-alt text-primary me-1"></i> Kartu Keluarga</h6>
                                                <div class="doc-img-container shadow-xs mb-3 border">
                                                    @if ($isKkPdf)
                                                        <i class="far fa-file-pdf text-danger fs-1"
                                                            style="cursor: pointer;"
                                                            onclick="openPreview('{{ asset($kk_file) }}', 'Kartu Keluarga')"></i>
                                                    @else
                                                        <img src="{{ asset($kk_file) }}" alt="Kartu Keluarga"
                                                            style="cursor:pointer;"
                                            ...
                                            <div>
                                                @if ($guru->scan_kk)
                                                    <a href="{{ route('guru.lengkapi_data.download.berkas', 'scan_kk') }}"
                                                        class="btn btn-primary btn-sm w-100 py-2 fw-semibold shadow-xs"><i
                                                            class="fas fa-download me-1"></i> Unduh Berkas</a>
                                                @else
                                                    <button class="btn btn-secondary btn-sm w-100 py-2" disabled><i
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div
                                            ...
                                            <div>
                                                <h6 class="fw-extrabold text-dark mb-2"><i
                                                        class="far fa-file-alt text-primary me-1"></i> Akta Kelahiran</h6>
                                                <div class="doc-img-container shadow-xs mb-3 border">
                                                    @if ($isAktaPdf)
                                                        <i class="far fa-file-pdf text-danger fs-1"
                                                            style="cursor: pointer;"
                                                            onclick="openPreview('{{ asset($akta_file) }}', 'Akta Kelahiran')"></i>
                                                    @else
                                                        <img src="{{ asset($akta_file) }}" alt="Akta Kelahiran"
                                                            style="cursor:pointer;"
                                            ...
                                            <div>
                                                @if ($guru->scan_akta)
                                                    <a href="{{ route('guru.lengkapi_data.download.berkas', 'scan_akta') }}"
                                                        class="btn btn-primary btn-sm w-100 py-2 fw-semibold shadow-xs"><i
                                                            class="fas fa-download me-1"></i> Unduh Berkas</a>
                                                @else
                                                    <button class="btn btn-secondary btn-sm w-100 py-2" disabled><i
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div
                                            ...
                                            <div>
                                                <h6 class="fw-extrabold text-dark mb-2"><i
                                                        class="far fa-id-card text-primary me-1"></i> KTP</h6>
                                                <div class="doc-img-container shadow-xs mb-3 border">
                                                    @if ($isKtpPdf)
                                                        <i class="far fa-file-pdf text-danger fs-1"
                                                            style="cursor: pointer;"
                                                            onclick="openPreview('{{ asset($ktp_file) }}', 'KTP')"></i>
                                                    @else
                                                        <img src="{{ asset($ktp_file) }}" alt="KTP"
                                                            style="cursor:pointer;"
                                            ...
                                            <div>
                                                @if ($guru->scan_ktp)
                                                    <a href="{{ route('guru.lengkapi_data.download.berkas', 'scan_ktp') }}"
                                                        class="btn btn-primary btn-sm w-100 py-2 fw-semibold shadow-xs"><i
                                                            class="fas fa-download me-1"></i> Unduh Berkas</a>
                                                @else
                                                    <button class="btn btn-secondary btn-sm w-100 py-2" disabled><i
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div
                                            ...
                                            <div>
                                                <h6 class="fw-extrabold text-dark mb-2"><i
                                                        class="far fa-file-alt text-primary me-1"></i> SK Kepegawaian</h6>
                                                <div class="doc-img-container shadow-xs mb-3 border">
                                                    @if ($isSkPdf)
                                                        <i class="far fa-file-pdf text-danger fs-1"
                                                            style="cursor: pointer;"
                                                            onclick="openPreview('{{ asset($sk_file) }}', 'SK Kepegawaian')"></i>
                                                    @else
                                                        <img src="{{ asset($sk_file) }}" alt="SK Kepegawaian"
                                                            style="cursor:pointer;"
                                            ...
                                            <div>
                                                @if ($guru->scan_sk)
                                                    <a href="{{ route('guru.lengkapi_data.download.berkas', 'scan_sk') }}"
                                                        class="btn btn-primary btn-sm w-100 py-2 fw-semibold shadow-xs"><i
                                                            class="fas fa-download me-1"></i> Unduh Berkas</a>
                                                @else
                                                    <button class="btn btn-secondary btn-sm w-100 py-2" disabled><i
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div
                                            ...
                                            <div>
                                                <h6 class="fw-extrabold text-dark mb-2"><i
                                                        class="far fa-file-alt text-primary me-1"></i> Transkrip Nilai</h6>
                                                <div class="doc-img-container shadow-xs mb-3 border">
                                                    @if ($isTranskripPdf)
                                                        <i class="far fa-file-pdf text-danger fs-1"
                                                            style="cursor: pointer;"
                                                            onclick="openPreview('{{ asset($transkrip_file) }}', 'Transkrip Nilai')"></i>
                                                    @else
                                                        <img src="{{ asset($transkrip_file) }}" alt="Transkrip Nilai"
                                                            style="cursor:pointer;"
                                            ...
                                            <div>
                                                @if ($guru->scan_transkrip_nilai)
                                                    <a href="{{ route('guru.lengkapi_data.download.berkas', 'scan_transkrip_nilai') }}"
                                                        class="btn btn-primary btn-sm w-100 py-2 fw-semibold shadow-xs"><i
                                                            class="fas fa-download me-1"></i> Unduh Berkas</a>
                                                @else
                                                    <button class="btn btn-secondary btn-sm w-100 py-2" disabled><i
    ...
    <div class="modal fade" id="previewModal" tabindex="-1" aria-labelledby="previewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div
                    class="modal-body text-center bg-dark p-3 rounded-bottom d-flex align-items-center justify-content-center">
            ...
            <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
                <form id="formPendidikan" data-parsley-validate enctype="multipart/form-data">
                    ...
                    <div class="modal-header bg-primary text-white py-3 border-0">
                        <h5 class="modal-title text-white fw-bold" id="modalTambahPendidikanLabel">Tambah Riwayat
                            Pendidikan</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-footer bg-light border-0 py-3">
                        ...
                        <button type="submit" class="btn btn-primary px-4 fw-semibold"><i class="fas fa-save me-1"></i>
                            Simpan</button>
                    </div>
                </form>
            </div>
        ...
        $(document).ready(function() {
            $('#formPendidikan').on('submit', function(e) {
                ...
                if ($(this).parsley().isValid()) {
                    ...
                    $.ajax({
                        url: "{{ route('guru.lengkapi_data.pendidikan.store') }}",
                        type: "POST",
                        data: formData,
                        processData: false,
                        contentType: false,
