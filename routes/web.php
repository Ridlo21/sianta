...
Route::middleware('auth')->group(function () {
    Route::middleware('role:admin')->group(function () {
        ...
        // SINKRONISASI SPMB
        Route::get('/admin/spmb-sync', [\App\Http\Controllers\SpmbSyncController::class, 'index'])->name('spmb.sync');
        Route::post('/admin/spmb-sync/process', [\App\Http\Controllers\SpmbSyncController::class, 'syncBatch'])->name('spmb.sync.process');
    });
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('admin/siswa_download_zip/{siswa}', [Siswacontroller::class, 'downloadZip'])->name('siswa.download.zip');
        ...
        Route::post('/admin/jadwal/version/create', [JadwalController::class, 'createVersion'])->name('jadwal.version.create');
        Route::post('/admin/jadwal/version/{id}/backup', [JadwalController::class, 'backupVersion'])->name('jadwal.version.backup');
        Route::get('/admin/jadwal/version/{id}/edit', [JadwalController::class, 'edit'])->name('jadwal.version.edit');
        Route::post('/admin/jadwal/save', [JadwalController::class, 'save'])->name('jadwal.save');
        Route::get('/admin/jadwal/version/{id}/print', [JadwalController::class, 'print'])->name('jadwal.print');
        Route::post('/admin/jadwal/version/{id}/delete', [JadwalController::class, 'deleteVersion'])->name('jadwal.version.delete');
        Route::post('/admin/jadwal/version/{id}/activate', [JadwalController::class, 'activateVersion'])->name('jadwal.version.activate');
    });

    // GURU PORTAL ROUTES
    Route::middleware('role:guru')->group(function () {
        Route::get('/guru/dashboard', [GuruPortalController::class, 'dashboard'])->name('guru.dashboard');
        Route::get('/guru/profile', [GuruPortalController::class, 'profile'])->name('guru.profile');
        Route::post('/guru/profile/update', [GuruPortalController::class, 'updateProfile'])->name('guru.profile.update');
        Route::post('/guru/profile/password', [GuruPortalController::class, 'updatePassword'])->name('guru.profile.password');
        
        // LENGKAPI BIODATA ROUTES
        Route::get('/guru/lengkapi_data/step1', [GuruPortalController::class, 'lengkapiStep1'])->name('guru.lengkapi_data.step1');
        Route::put('/guru/lengkapi_data/update/step1', [GuruPortalController::class, 'updateLengkapiStep1'])->name('guru.lengkapi_data.update.step1');
        Route::get('/guru/lengkapi_data/step2', [GuruPortalController::class, 'lengkapiStep2'])->name('guru.lengkapi_data.step2');
        Route::put('/guru/lengkapi_data/update/step2', [GuruPortalController::class, 'updateLengkapiStep2'])->name('guru.lengkapi_data.update.step2');
        Route::get('/guru/lengkapi_data/show', [GuruPortalController::class, 'lengkapiShow'])->name('guru.lengkapi_data.show');
        Route::get('/guru/lengkapi_data/upload', [GuruPortalController::class, 'lengkapiUpload'])->name('guru.lengkapi_data.upload');
        Route::post('/guru/lengkapi_data/update/upload', [GuruPortalController::class, 'updateLengkapiUpload'])->name('guru.lengkapi_data.update.upload');
        Route::post('/guru/lengkapi_data/pendidikan', [GuruPortalController::class, 'storePendidikan'])->name('guru.lengkapi_data.pendidikan.store');
        Route::get('/guru/lengkapi_data/pendidikan/download/{id}', [GuruPortalController::class, 'downloadPendidikanBerkas'])->name('guru.lengkapi_data.pendidikan.download');
        Route::get('/guru/lengkapi_data/download_berkas/{field}', [GuruPortalController::class, 'downloadBerkas'])->name('guru.lengkapi_data.download.berkas');
    });
});
